...
class ReportJob(Base):
    ...
    artifact_pdf_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    artifact_xlsx_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    artifact_pdf_public_id: Mapped[str | None] = mapped_column(Text, nullable=True)
    artifact_xlsx_public_id: Mapped[str | None] = mapped_column(Text, nullable=True)
